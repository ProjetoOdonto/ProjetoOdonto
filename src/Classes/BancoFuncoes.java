...
//        System.out.println("Fornecedores Recuperados com sucesso");
      ...
      return null;
             ...
             public BancoFuncoes
           tabelaDespecas(String sql, String msg1, String msg2, final JTable gridCliente){
   ...
   try {
        ...
        Statement s = (Statement) connection.createStatement();
          ...
          javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel)gridCliente.getModel();
                   ...
                   while (rs.next()){
                       String coddespecas = rs.getString("COD_DESPECAS");
                       ...
                       String fornecedor = rs.getString("ds_fornecedor");
                        ...
                        dtm.addRow(new Object[]{coddespecas,fornecedor,valor,situacao});
                   }
