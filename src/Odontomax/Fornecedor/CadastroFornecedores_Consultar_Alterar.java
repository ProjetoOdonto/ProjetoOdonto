...
public class CadastroFornecedores_Consultar_Alterar extends javax.swing.JFrame {
    ...
    public CadastroFornecedores_Consultar_Alterar(Fornecedor f, Usuario user) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_alterar.setBounds(610, 80, 100, 50);
        ...
        setSize(new java.awt.Dimension(741, 552));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroFornecedores_Consultar_Alterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
